...
public class ClientManager {
   ...
   public List<Client> changeClient(List<Client> clients) {
        ...
        System.out.println("Имя: "+clients.get(numberClient-1).getFirstname());
        System.out.println(clients.get(numberClient - 1).getMony()+" нынешний щет клиента");
        System.out.println("Введите деньги клиента: ");
        clients.get(numberClient - 1).setMony(scanner.nextInt());
        return clients;
}
